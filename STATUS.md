...
Reconciled on **2026-09-03** against the v0.79 release line, the checked-in OpenAPI
...
- **Release line:** 60 tagged releases, v0.20 through v0.79, cut 2026-08-21 through
  2026-09-03.
...
**56 operations across 51 paths, 55 under `/v1`**, counted from `tests/contract/openapi_snapshot.json`
...
| **P2** Serving and map | Substantially met | 56 operations, tiles with the allowlist asserted in CI, map/card/drawer/glossary/explorer/Status all shipped. `/v1/spacingunits` unserved; permits, GOR and water-cut remain |
