...
Reconciled on **2026-08-26** against the v0.52 release line, the checked-in OpenAPI
...
- **Release line:** 33 tagged releases, v0.20 through v0.52, cut 2026-08-21 through
  2026-08-26.
...
1. Build the pinned type-curve control from `mdv1.2`, enforce the identical split ids, and
