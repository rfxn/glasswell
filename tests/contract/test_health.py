...
# Five ND, nine NM, three TX and two land (BLM PLSS) sources from seed_all, plus the three
# the shared test template carries — nd_mpr_xlsx and nm_ocd_wcproduction are in both, so
# only tx_pdq_dsv adds to the total.
SOURCE_COUNT = 20
