...
The differ is a pure function over two documents, so every test here builds both of them --
the committed snapshot for the two that need a real one. The one test that needs the *served*
document, and so a database, stays in the contract tier.
"""
