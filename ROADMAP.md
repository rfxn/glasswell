...
| **P3** Forecasting and benchmark | **Entry gate met; implementation not started.** Canonical has 131 distinct production months, earliest 2015-05-01, against the ≥ 120 and ≤ 2016-01 gate. No feature builder, type-curve control, model, calibration, analog index or harness; the model registry is DDL with no writer |
